  ...
  if (cartItems.length === 0) {
    return (
      <Box sx={{ minHeight: '70vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 2, px: 2 }}>
        ...
        <Typography variant="h5" fontWeight={800} color="#1a1a1a">Your cart is empty</Typography>
        ...
        <Button
          ...
          sx={{
            mt: 1, px: 3, py: 1.2, borderRadius: 3, fontWeight: 700,
        ...
        <Box sx={{ display: 'flex', gap: 3, alignItems: 'flex-start', flexDirection: { xs: 'column', md: 'row' } }}>
          ...
          >
            ...
            <Box sx={{ background: `linear-gradient(135deg, ${PINK[600]}, ${PINK[500]})`, px: 2.5, py: 2 }}>
              <Typography fontWeight={800} fontSize={16} color="#fff">Order Summary</Typography>
            </Box>
            ...
            <Box sx={{ p: 2.5 }}>
                ...
                {cartItems.map((item) => {
                  ...
                  return (
                    <Box key={item.id} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 1 }}>
                      <Typography fontSize={13} color="text.secondary" sx={{ flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        {item.product?.name ?? 'Product'}
                        <Box component="span" sx={{ ml: 0.5, color: '#bbb', fontSize: 12 }}>×{item.quantity}</Box>
                      </Typography>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1.2 }}>
                ...
                <Typography fontSize={14} fontWeight={700}>₹{subtotal.toFixed(0)}</Typography>
              </Box>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                <Typography fontSize={16} fontWeight={800}>Total</Typography>
              ...
              <Button
                ...
                sx={{
                  mb: 1.5, py: 1.5, fontWeight: 800, fontSize: 15, borderRadius: 3,
                  background: `linear-gradient(135deg, ${PINK[600]}, ${PINK[500]})`,
              ...
              <Button
                ...
                onClick={() => navigate('/products')}
                sx={{
                  py: 1.3, borderRadius: 3, fontWeight: 700, fontSize: 14,
                  borderColor: PINK[100], color: PINK[600],
                    ...
                    >
                      ...
                      {discountPct > 0 && (
                        <Box sx={{
                          ...
                          px: 0.8, py: 0.3, borderRadius: '6px', lineHeight: 1.5,
                          zIndex: 1,
                        }}>
                          -{discountPct}%
                        </Box>
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 0.8 }}>
                        ...
                        {hasDiscount && (
                          <Box sx={{
                            ...
                            px: 0.7, py: 0.2, borderRadius: 1, lineHeight: 1.6,
                          }}>
                            {discountPct}% off
                          </Box>
                        )}
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mt: 'auto' }}>
                        ...
                        <Box sx={{
                          ...
                          <Box sx={{
                            ...
                            {isUpdating
                              ? <CircularProgress size={11} sx={{ color: PINK[500], verticalAlign: 'middle' }} />
                              : item.quantity
                            }
                          </Box>
                          <IconButton
                            ...
                            onClick={() => updateQuantity(item.id, item.quantity + 1)}
                            sx={{
                              width: 32, height: 32, borderRadius: 0, color: '#555',
                        ...
                        <Box sx={{ textAlign: 'right' }}>
                          <Typography fontSize={11} color="text.disabled" lineHeight={1.3}>Item total</Typography>
